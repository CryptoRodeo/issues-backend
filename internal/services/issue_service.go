...
func (s *IssueService) CreateIssue(req dto.CreateIssueRequest) (*models.Issue, error) {
...
func (s *IssueService) UpdateIssue(id string, req dto.UpdateIssueRequest) (*models.Issue, error) {
	// Find existing issue
